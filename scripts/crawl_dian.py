"""Crawl de la Compilación Jurídica de la DIAN: HTML estático, sin necesidad
de navegador. Cubre tributario/aduanero/cambiario en cada corrida."""
...
from ingest.fuentes.dian import crawl
from ingest.schema import Documento
from scripts._crawl_retry import crawl_con_reintentos

SALIDA = Path(__file__).resolve().parent.parent / "data" / "raw" / "dian.json"
